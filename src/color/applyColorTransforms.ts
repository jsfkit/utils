 ...
 * Note that the {@link toRGBA} function does this automatically.
 *
 * @param rgba The base RGBA color to use.
 * @param transforms A list of `ColorTransform` objects to apply.
 * @returns A transformed RGBA color.
 */
